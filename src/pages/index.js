...
import quizapp from "../../content/assets/projects/quizapp.png"
import gumbo from "../../content/assets/projects/gumbo.png"
import seosift from "../../content/assets/projects/seosift.jpg"
...
const Home = () =>{
    ...
    <section className="section">
      ...
      <img
        alt="Queenscript image icon"
        className="about-me"
        src="https://lh3.googleusercontent.com/GWqgaByVST3Sg3gNYvdtX7LklKFV6TwFnKO1po1RekiD6NlKjnDaDEdccNgChKemUo19syrxp4DZCUBx2Nyg3V__9LFkTwbBZcEk9kIPpQc_5fPWG3pE1hYPWdCdzeE3TTM8cNnaqco=s756-no"
      />
    <h4 className="intro-text">
        Problem Solver. Developer. Designer. Poet.
	  </h4>
    </section>
   
    <section id ="intro" className="section">
    <div style={{display: "block", position: "relative",
    top: -50, visibility: "hidden"}}  id="about"></div>
      <h4>JavaScript Impassioned Full Stack Engineer</h4>
      <p className="about">
        I am a full stack engineer with a passion for front-end web
        technologies, frameworks, and libraries including vanilla Javascript,
        jQuery, React and Vue.js. When I dabble on the back end, you can find me
        working with Python, Ruby, Node and databases like MongoDB and PostgreSQL.
        I'd love to work with awesome programmers who are also versed in these technologies so that we can sharpen our skills as a team. When I'm not coding, I'm doing something creative with words from my
        lettering projects to my performative poetry.
        
      </p>
    </section>
    <div style={{display: "block", position: "relative",
    top: -50, visibility: "hidden"}} id="portfolio"></div>
    <h4> I Build Things, Here's Some of My Work: </h4>
    <section className="projects" id="seo">
      <h2>SEOsift</h2>
      <p className="description">
        SEOsift scrapes the source code of websites for information on its web
        build, or content management systems, CMS. SEOsift additionally looks
        for SEO ranking scores. You can test your web builder knowledge in the
        CMS Quiz App below!
      </p>

      <a target="_blank" href="http://seosift.com/">
        <img alt="project image of SEOsift.com" className="project-image" src={seosift}
      /></a>
      <p className="stack">
      ...
      <a target="_blank" href="https://github.com/QueenShabazz/seosift">
        Link to GitHub repo
      </a>
      <a target="_blank" href="http://seosift.com/"> Link to live site 
      </a>
    ...
    <section className="projects">
      ...
      <a target="_blank" href="https://gumbo.netlify.com/">
        <img alt="project image of the Gumbo App" className="project-image" src={gumbo}/></a>
      <p className="stack">
        Technologies used in this project include:
        <span className="techcons">
          <svg viewBox="0 0 128 128" data-name="js" className="tech-icon">
      ...
      <a target="_blank" href="https://github.com/QueenShabazz/gumbo">
        Link to GitHub repo
      </a>
      <a target="_blank" href="https://gumbo.netlify.com/"> Link to live site </a>
    </section>
    <section className="projects">
      <h2>CMS Quiz App</h2>
      <p className="description">
        This CMS Quiz App is a subjectively focused quiz that asks the user to
        choose the best CMS based on the provided persona profile.
      </p>

      <a target="_blank" href="https://queenshabazz.github.io/quizapp/"
        ><img alt="project image of Quiz App" className="project-image" src={quizapp}
      /></a>
      <p className="stack">
        Technologies used in this project include:
        <svg viewBox="0 0 128 128" data-name="js" className="tech-icon">
      ...
      <a target="_blank" href="https://github.com/QueenShabazz/quizapp">
        Link to GitHub repo
      </a>
      <a target="_blank" href="https://queenshabazz.github.io/quizapp/">
        Link to live site
